...
const labels = {
  ...
  tagFilter: { zh: "分类筛选", en: "Taxonomy Filters" },
  clearFilter: { zh: "清除", en: "Clear" },
  references: { zh: "参考来源", en: "References" },
  searchCombined: { zh: "内容+分类", en: "Content + Taxonomy" },
  searchTag: { zh: "标签", en: "Tag" },
  searchContent: { zh: "全文", en: "Content" },
  searchPlaceholderCombined: { zh: "搜索问题、答案、分类...", en: "Search questions, answers, or taxonomy..." },
