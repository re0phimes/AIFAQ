...
| # | 问题 | 日期 | 标签 |
|---|------|------|------|
| 1 | 残差连接中 F(x) 代表什么？ | 2026-02-23 | #残差连接 #Transformer |
| 2 | 残差连接的梯度公式及 "+1" 项的作用 | 2026-02-23 | #残差连接 #梯度 |
| 3 | 为什么传统网络难以学习恒等映射？ | 2026-02-23 | #残差连接 #恒等映射 |
| 4 | 为什么用 Add 而不用 Concat？ | 2026-02-23 | #残差连接 #特征融合 |
| 5 | 网络退化和过拟合的区别 | 2026-02-23 | #网络退化 #深度学习 |
| 6 | F(x) 值远大于 x 会怎样？ | 2026-02-23 | #残差连接 #训练稳定性 |
| 7 | 为什么 Add 之后必须跟 Norm？ | 2026-02-23 | #Add&Norm #归一化 |
| 8 | 防止 F(x) 值过大的三种手段 | 2026-02-23 | #训练技巧 #归一化 |
| 9 | Q、K、V 从哪里来？Wq/Wk/Wv 的初始状态 | 2026-02-23 | #注意力机制 #Transformer |
| 10 | 为什么不能直接训练 Q、K、V 而必须用权重矩阵？ | 2026-02-23 | #注意力机制 #反面题 |
| 11 | sqrt(d_k) 缩放因子的作用 | 2026-02-23 | #注意力机制 #缩放点积 |
| 12 | 点积在注意力机制中的语义含义 | 2026-02-23 | #注意力机制 #点积 |
| 13 | 为什么用三个矩阵而不是更多？ | 2026-02-23 | #注意力机制 #QKV |
| 14 | Wq/Wk/Wv 训练三阶段分别学到什么？ | 2026-02-23 | #注意力机制 #训练过程 |
| 15 | BN 的成功原因是解决 ICS 吗？真正原因是什么？ | 2026-02-23 | #BatchNorm #损失曲面 |
| 16 | 利普希茨常数 L 大和 L 小分别意味着什么？ | 2026-02-23 | #优化理论 #损失曲面 |
| 17 | 为什么 BatchNorm 不适用于 NLP 任务？ | 2026-02-23 | #BatchNorm #NLP |
| 18 | 仿射变换在 Normalization 中的作用是什么？ | 2026-02-23 | #归一化 #仿射变换 |
| 19 | 不同 Norm 方法公式几乎相同，为什么效果差异巨大？ | 2026-02-23 | #归一化 #作用域 |
| 20 | CNN 中的 LayerNorm 和 Transformer 中的 LayerNorm 有什么区别？ | 2026-02-23 | #LayerNorm #Transformer |
| 21 | Transformer-LayerNorm 和 CNN-InstanceNorm 都是"一条"，区别是什么？ | 2026-02-23 | #LayerNorm #InstanceNorm |
| 22 | RMSNorm 相比 LayerNorm 简化了什么？为什么可以简化？ | 2026-02-23 | #RMSNorm #LayerNorm |
| 23 | 多头注意力的核心思想是什么？d_k 和 d_model 的关系？ | 2026-02-23 | #多头注意力 #Transformer |
| 24 | 多头注意力的理论描述和代码实现有什么不同？ | 2026-02-23 | #多头注意力 #工程实践 |
| 25 | 为什么多个头能学到不同的语义特征？ | 2026-02-23 | #多头注意力 #梯度 |
| 26 | 如果多个头的梯度方向高度一致会怎样？ | 2026-02-23 | #多头注意力 #反面题 |
| 27 | 头的数量如何选定？每个头的维度通常不低于多少？ | 2026-02-23 | #多头注意力 #模型设计 |
| 28 | split_heads 操作的维度变化过程是什么？ | 2026-02-23 | #多头注意力 #维度变换 |
| 29 | FFN 的"扩展-激活-压缩"路径的作用是什么？ | 2026-02-23 | #FFN #Transformer |
| 30 | 如果 FFN 中没有激活函数会怎样？ | 2026-02-23 | #FFN #反面题 |
| 31 | Attention 中的 softmax 已经是非线性的，为什么还需要 FFN？ | 2026-02-23 | #FFN #注意力机制 |
| 32 | 为什么 FFN 通常在 Attention 之后而不是之前？ | 2026-02-23 | #FFN #Transformer |
| 33 | 线性变换的两个核心局限性是什么？ | 2026-02-23 | #线性变换 #深度学习 |
| 34 | ReLU 在 FFN 中的作用可以用什么直觉理解？ | 2026-02-23 | #ReLU #激活函数 |
| 35 | 激活函数优化的三个主要目标是什么？ | 2026-02-23 | #激活函数 #优化目标 |
| 36 | ReLU 的"神经元死亡"问题是什么？为什么会发生？ | 2026-02-23 | #ReLU #神经元死亡 |
| 37 | GELU 相比 ReLU 的核心优势是什么？ | 2026-02-23 | #GELU #ReLU |
| 38 | GLU 门控结构和传统 FFN 的区别是什么？ | 2026-02-23 | #GLU #FFN |
| 39 | 为什么非门控时 GELU 更流行，门控结构中 SwiGLU 更优？ | 2026-02-23 | #SwiGLU #GELU |
| 40 | 从 ReLU 到 SwiGLU 的演变逻辑是什么？ | 2026-02-23 | #激活函数 #FFN |
| 41 | 为什么 ELU 理论优势未能转化为实际收益？ | 2026-02-23 | #ELU #反面题 |
| 42 | MoE 和 SwiGLU 的门控思想有什么关系？ | 2026-02-23 | #MoE #SwiGLU |
| 43 | 为什么词嵌入和位置编码可以直接相加而不破坏语义？ | 2026-02-23 | #Embedding #位置编码 |
| 44 | 正余弦位置编码为什么必须同时使用 sin 和 cos？ | 2026-02-23 | #位置编码 #反面题 |
| 45 | 频率缩放因子 1/10000^(2i/d_model) 的设计意图是什么？ | 2026-02-23 | #位置编码 #公式 |
| 46 | 语义空间和位置空间的正交性是天然的还是学习得到的？ | 2026-02-23 | #Embedding #位置编码 |
| 47 | 注意力分数 QK^T 可以分解为哪四个部分？ | 2026-02-23 | #注意力机制 #位置编码 |
| 48 | FFN 为什么叫 Position-wise？这对位置编码有什么启示？ | 2026-02-23 | #FFN #位置编码 |
| 49 | 正余弦编码的有界性为什么重要？ | 2026-02-23 | #位置编码 #有界性 |
| 50 | 流形假说是什么？它如何帮助理解 Embedding？ | 2026-02-24 | #Embedding #流形假说 |
| 51 | King-Man+Woman≈Queen 为什么能成立？ | 2026-02-24 | #Embedding #流形 |
| 52 | 为什么余弦相似度是一种"有风险的近似"？ | 2026-02-24 | #Embedding #RAG |
...
| 62 | GPT 已经很强了，为什么工业界还需要 BERT？ | 2026-02-24 | #BERT #工程实践 |
| 63 | Prefill 和 Decoding 阶段在计算模式上的核心区别是什么？ | 2026-02-24 | #KVCache #推理阶段 |
| 64 | 为什么 Decoding 阶段只缓存 K 和 V，不缓存 Q？ | 2026-02-24 | #KVCache #注意力机制 |
| 65 | 没有 KV Cache 时，生成 N 个 token 的重复计算量为什么是 O(N²) 级别？ | 2026-02-24 | #KVCache #计算复杂度 |
| 66 | "内存墙"问题的本质是什么？ | 2026-02-24 | #内存墙 #MemoryBound |
| 67 | KV Cache 显存占用公式中，为什么优化目标锁定在 n_heads 而非其他参数？ | 2026-02-24 | #KVCache #Attention优化 |
| 68 | Prefill 阶段为什么是 GEMM，Decoding 阶段为什么退化为 GEMV？ | 2026-02-24 | #GEMM #GEMV |
| 69 | MQA 和 GQA 分别如何减少 KV Cache？各自的代价是什么？ | 2026-02-24 | #MQA #GQA |
| 70 | 从代码角度看，MHA 改为 MQA/GQA 只需修改哪三处？ | 2026-02-24 | #MQA #GQA #工程实践 |
| 71 | GQA-8 将 KV Cache 压缩了 75%，但 BS=1 时搬运时间只从 20.2ms 降到 18.2ms，为什么效果不明显？ | 2026-02-24 | #GQA #MemoryBound |
| 72 | 搬运时间为什么是 BS 的仿射函数而非正比例函数？截距的物理含义是什么？ | 2026-02-24 | #MemoryBound #推理优化 |
| 73 | 为什么 MHA 和 GQA 在数学上永远无法翻转到 Compute Bound，而 MQA 理论上可以？ | 2026-02-24 | #ComputeBound #MemoryBound |
| 74 | MLA 的"以算换存"核心思想是什么？ | 2026-02-24 | #MLA #KVCache |
| 75 | 矩阵吸收（Weight Absorption）的关键推导是什么？为什么能跳过 Up-Projection？ | 2026-02-24 | #MLA #矩阵吸收 |
| 76 | MLA 在 LlaMA-2-7B（n_h=32）上仍是 Memory Bound，需要多少个 head 才能翻转到 Compute Bound？ | 2026-02-24 | #MLA #ComputeBound |
| 77 | RoPE 为什么会破坏矩阵吸收？Decoupled RoPE 如何解决？ | 2026-02-24 | #RoPE #MLA |
| 78 | 分别推导 MHA、GQA-8、MQA、MLA 单层每 token 的 KV Cache 元素数公式，并计算压缩比 | 2026-02-24 | #KVCache #公式推导 |
| 79 | MLA 不做矩阵吸收时，Up-Projection 的 FLOPs 如何计算？为什么"直接解压"反而更慢？ | 2026-02-24 | #MLA #公式推导 |
| 80 | 推导 MQA 场景下计算时间追上搬运时间的 BS 交叉点公式 | 2026-02-24 | #MQA #公式推导 |
| 81 | Decoupled RoPE 引入后，DeepSeek-V2 每 token 每层的存储量和压缩比是多少？ | 2026-02-24 | #DecoupledRoPE #公式推导 |
...
## 9. Q、K、V 从哪里来？Wq/Wk/Wv 的初始状态

**日期**: 2026-02-23
**参考**:
- 来源文章: Transformer中的Q和K 2025-01-29.md

**标签**: #注意力机制 #Transformer
...
## 15. BN 的成功原因是解决 ICS 吗？真正原因是什么？

**日期**: 2026-02-23
**参考**:
- 来源文章: Add & Norm （二）从传统CV到Transformer里的Normalizaiton详解.md
- Santurkar, S., et al. "How Does Batch Normalization Help Optimization?", arXiv:1805.11604, 2019
...
## 18. 仿射变换在 Normalization 中的作用是什么？
...
## 20. CNN 中的 LayerNorm 和 Transformer 中的 LayerNorm 有什么区别？

**日期**: 2026-02-23
**参考**:
- 来源文章: Add & Norm （二）从传统CV到Transformer里的Normalizaiton详解.md

**标签**: #LayerNorm #Transformer
...
## 21. Transformer-LayerNorm 和 CNN-InstanceNorm 都是"一条"，区别是什么？

**日期**: 2026-02-23
**参考**:
- 来源文章: Add & Norm （二）从传统CV到Transformer里的Normalizaiton详解.md

**标签**: #LayerNorm #InstanceNorm
...
## 22. RMSNorm 相比 LayerNorm 简化了什么？为什么可以简化？

**日期**: 2026-02-23
**参考**:
- 来源文章: Add & Norm （二）从传统CV到Transformer里的Normalizaiton详解.md

**标签**: #RMSNorm #LayerNorm
...
## 23. 多头注意力的核心思想是什么？d_k 和 d_model 的关系？

**日期**: 2026-02-23
**参考**:
- 来源文章: Transformer之多头注意力.md
- Vaswani, A., et al. "Attention Is All You Need", arXiv:1706.03762, 2017

**标签**: #多头注意力 #Transformer
...
## 29. FFN 的"扩展-激活-压缩"路径的作用是什么？

**日期**: 2026-02-23
**参考**:
- 来源文章: 为什么前馈神经网络（FFN）对Transformer这么重要（一）.md
- Vaswani, A., et al. "Attention Is All You Need", arXiv:1706.03762, 2017
...
两次线性变换退化为一次：W2(W1*X) = (W2*W1)X，等效于单一线性层，完全无法扩展模型的表达能力。线性变换只能做拉伸、旋转、平移，无论叠加多少次，直线仍是直线，无法产生非线性决策边界。激活函数是 FFN 获得表达能力的关键——它让模型能学习"阈值"式的特征组合，比如只有当多个特征同时达到一定强度时才激活。

---

## 31. Attention 中的 softmax 已经是非线性的，为什么还需要 FFN？
...
## 32. 为什么 FFN 通常在 Attention 之后而不是之前？
...
(1) 线性特征不变——无论对数据施加多少次线性变换，直线仍是直线、超平面仍是超平面，无法产生非线性决策边界（如无法解决 XOR 问题）。(2) 多次线性变换等效于一次——W2(W1*X) = (W2*W1)X，多层线性网络在表达能力上等价于单层，无法通过堆叠线性层来增加模型复杂度。

---

## 34. ReLU 在 FFN 中的作用可以用什么直觉理解？
...
**日期**: 2026-02-23
**参考**:
- 来源文章: 前馈神经网络（FFN）详解（二）：从激活函数到MOE.md
...
## 39. 为什么非门控时 GELU 更流行，门控结构中 SwiGLU 更优？
...
## 43. 为什么词嵌入和位置编码可以直接相加而不破坏语义？

**日期**: 2026-02-23
**参考**:
- 来源文章: 为什么Embedding加上位置编码后不会破坏语义？.md
...
## 45. 频率缩放因子 1/10000^(2i/d_model) 的设计意图是什么？
...
由于 H = E + P（词嵌入 + 位置编码），Q = (E+P)*Wq，K = (E+P)*Wk，展开 QK^T 得到四项：(1) 语义-语义：(E*Wq)(E*Wk)^T，捕捉纯粹词义相关性；(2) 位置-位置：(P*Wq)(P*Wk)^T，捕捉纯粹位置关系；(3) 语义-位置：(E*Wq)(P*Wk)^T，某词对某位置的偏好；(4) 位置-语义：(P*Wq)(E*Wk)^T，某位置对某词的偏好。不同的注意力头可能侧重不同部分，形成语义专家头和位置专家头。

---

## 48. FFN 为什么叫 Position-wise？这对位置编码有什么启示？
...
## 50. 流形假说是什么？它如何帮助理解 Embedding？

**日期**: 2026-02-24
**参考**:
- 来源文章: 流形视角下的Embedding：从理论到RAG实践.md
...
## 51. King-Man+Woman≈Queen 为什么能成立？
...
## 53. 从流形视角看，为什么 LoRA 微调只需少量高质量数据？
...
## 55. 为什么 Embedding 需要 768 维甚至更高的维度？
...
## 56. max_position_embeddings 是什么？超过会怎样？
...
## 59. 从任务角度看，BERT 和 GPT 为什么选择了不同的架构？

**日期**: 2026-02-24
**参考**:
- 来源文章: 通过下游任务理解BERT和GPT的区别：不只是完形填空和词语接龙.md
...
## 63. Prefill 和 Decoding 阶段在计算模式上的核心区别是什么？

**日期**: 2026-02-24
**参考**:
- 来源文章: KV Cache（一）：从KV Cache看懂Attention（MHA、MQA、GQA、MLA）的优化之路.md
...
## 64. 为什么 Decoding 阶段只缓存 K 和 V，不缓存 Q？
...
## 65. 没有 KV Cache 时，生成 N 个 token 的重复计算量为什么是 O(N²) 级别？
...
## 67. KV Cache 显存占用公式中，为什么优化目标锁定在 n_heads 而非其他参数？

**日期**: 2026-02-24
**参考**:
- 来源文章: KV Cache（一）：从KV Cache看懂Attention（MHA、MQA、GQA、MLA）的优化之路.md

**标签**: #KVCache #Attention优化
...
## 68. Prefill 阶段为什么是 GEMM，Decoding 阶段为什么退化为 GEMV？
...
## 69. MQA 和 GQA 分别如何减少 KV Cache？各自的代价是什么？
...
## 70. 从代码角度看，MHA 改为 MQA/GQA 只需修改哪三处？

**日期**: 2026-02-24
**参考**:
- 来源文章: KV Cache（二）：从如何让GPU不摸鱼开始思考——MQA、GQA到MLA的计算拆解。.md
...
## 71. GQA-8 将 KV Cache 压缩了 75%，但 BS=1 时搬运时间只从 20.2ms 降到 18.2ms，为什么效果不明显？
...
## 72. 搬运时间为什么是 BS 的仿射函数而非正比例函数？截距的物理含义是什么？
...
## 73. 为什么 MHA 和 GQA 在数学上永远无法翻转到 Compute Bound，而 MQA 理论上可以？

**日期**: 2026-02-24
**参考**:
- 来源文章: KV Cache（二）：从如何让GPU不摸鱼开始思考——MQA、GQA到MLA的计算拆解。.md

**标签**: #ComputeBound #MemoryBound
...
## 75. 矩阵吸收（Weight Absorption）的关键推导是什么？为什么能跳过 Up-Projection？
...
## 76. MLA 在 LlaMA-2-7B（n_h=32）上仍是 Memory Bound，需要多少个 head 才能翻转到 Compute Bound？
...
## 77. RoPE 为什么会破坏矩阵吸收？Decoupled RoPE 如何解决？
...
## 78. 分别推导 MHA、GQA-8、MQA、MLA 单层每 token 的 KV Cache 元素数公式，并计算压缩比
...
## 79. MLA 不做矩阵吸收时，Up-Projection 的 FLOPs 如何计算？为什么"直接解压"反而更慢？
...
## 80. 推导 MQA 场景下计算时间追上搬运时间的 BS 交叉点公式
...
## 81. Decoupled RoPE 引入后，DeepSeek-V2 每 token 每层的存储量和压缩比是多少？
